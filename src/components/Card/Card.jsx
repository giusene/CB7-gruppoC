    ...
    return(
        <>
                ...
                <div className={styles.Card}>
                    ...
                    <div className={styles.bgCard}>
                        <img className={styles.bgImage} src={`https://image.tmdb.org/t/p/w300${mock.backdrop_path}`} alt="" />
                        <div className={styles.black}>
                            <p className={styles.black_parag}>{mock.title}</p>
                        </div>
                        </div>
                    <div className={styles.text}>
                        <div className={styles.card_title}>
                                ...
                                <p className={styles.heart} onClick={()=> changedHeart()}>
                                    {heart ? <AiFillHeart className={styles.heart_icon}/> : <AiOutlineHeart className={styles.heart_icon}/>}
                                    </p>
                        </div>
                        <div className={styles.info}>
                            <div className="year">
                            ...
                            {mock.runtime && <div className="duration">
                                {minutesInHours(mock.runtime)}
                            </div>}

                        </div>
                        <div className="card_description">
                                <p className={styles.overview}>{mock.overview.slice(0,100) + "..."}</p>
                        </div>
                    </div>
                </div>
